...
namespace DaroohaNewSite.Presentation.Helpers.Filters
{
    public class UserCheckIdFilter : ActionFilterAttribute
    {
        ...
        public override void OnActionExecuting(ActionExecutingContext context)
        {
            ...
            else
            {
                ...
                {
                    _logger.LogError($"کاربر  آقا/خانم {context.RouteData.Values["userId"].ToString()} درخواست غیرمحاز برای ویرایش یوزر دیگیری کرده است ");
                    context.Result = new UnauthorizedResult();
                }
            }
